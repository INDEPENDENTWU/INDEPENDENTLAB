window.DINNER_STEPS=[
{id:'people',title:'跟谁？',type:'choice',options:[['想见的人','want',3],['熟人','familiar',1],['不太熟','not-close',-1],['其实不太想见','avoid',-3]]},
{id:'travel',title:'来回要多久？',type:'choice',options:[['半小时内','short',1.5],['差不多一小时','medium',0],['两小时左右','long',-2],['光想想就累','pain',-3]]},
{id:'spend',title:'大概要花多少？',type:'choice',options:[['一百以内','low',.5],['一百到三百','mid',0],['三百以上','high',-2],['不好说','unknown',0]]},
